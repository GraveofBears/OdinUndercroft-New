...
namespace OdinUndercroft
{
    ...
    public class OdinUndercroftPlugin : BaseUnityPlugin
    {
        ...
        private static List<GameObject> _needCraftingStation;
...

        {
            ...
            _needCraftingStation.Add(OdinsUndercroft.Prefab);
            ...
            _needCraftingStation.Add(OU_MetalGrate.Prefab);
            ...
            _needCraftingStation.Add(OU_Sarcophagus.Prefab);
            ...
            _needCraftingStation.Add(OU_Sarcophagus_Lid.Prefab);
            ...
            _needCraftingStation.Add(OU_Skeleton_Full.Prefab);
            ...
            _needCraftingStation.Add(OU_Skeleton_Hanging.Prefab);
            ...
            _needCraftingStation.Add(OU_Skeleton_Pile.Prefab);
            ...
            _needCraftingStation.Add(OU_StoneArchway.Prefab);
            ...
            _needCraftingStation.Add(OU_StoneWall.Prefab);
            ...
            _needCraftingStation.Add(OU_DrainPipe.Prefab);
            ...
            _needCraftingStation.Add(OU_CornerCap.Prefab);
            ...
            _needCraftingStation.Add(OU_StoneBeam.Prefab);
        ...
        static class ZNetScene_Awake_Patch
        {
            ...
            {
                foreach (GameObject o in _needCraftingStation)
                {
                    o.GetComponent<Piece>().m_craftingStation =
